...
# adding typical noise and no bias
swmm_results_h5l1_typical_noise <- get_inflow_outflow_swmm(swmm_h5l1_stage, 0, 0.01, 184, 200,  0, 3.33, 3.3, 60)
# adding maximum noise and no bias
swmm_results_h5l1_max_noise <- get_inflow_outflow_swmm(swmm_h5l1_stage, 0, 0.02, 184, 200,  0, 3.33, 3.3, 60)
# adding no noise and +1cm bias
...
# typical noise and +1cm bias
swmm_results_h5l1_typical_noise_plus1cm <- get_inflow_outflow_swmm(swmm_h5l1_stage, 1/(2.54*12), 0.01, 184, 200,  0, 3.33, 3.3, 60)
# typical noise and -1cm bias
swmm_results_h5l1_typical_noise_minus1cm <- get_inflow_outflow_swmm(swmm_h5l1_stage, -1/(2.54*12), 0.01, 184, 200,  0, 3.33, 3.3, 60)
# typical noise and +5cm bias
swmm_results_h5l1_typical_noise_plus5cm <- get_inflow_outflow_swmm(swmm_h5l1_stage, 5/(2.54*12), 0.01, 184, 200,  0, 3.33, 3.3, 60)
# typical noise and -5cm bias
swmm_results_h5l1_typical_noise_minus5cm <- get_inflow_outflow_swmm(swmm_h5l1_stage, -5/(2.54*12), 0.01, 184, 200,  0, 3.33, 3.3, 60)
```
